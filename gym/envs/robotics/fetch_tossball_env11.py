...
class FetchTossballEnv11(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        super(FetchTossballEnv11, self).__init__(
...
#anton, changed goal to be in 25% of the cases on the upper table to have it tossed
    ...
    def render(self, mode='human', width=500, height=500):
        return super(FetchTossballEnv11, self).render(mode, width, height)
